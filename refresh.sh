...
./evonet -selection 1 -s2 5  -N 1000 -ploidy 1 -swapping 1 -freq 10 -min_R1R2 1 -max_R1R2 100 -min_count 3 -max_count 152 -generations 101 -n 10
#Rscript mine.R fitness.png 1000 2 100 10 fitness.txt discrete.txt robustness.txt matrix.txt robust_percent.txt
